...
<html lang="es">
  <head>
    ...
    <title>Recuperar Cuenta Tecnología 5G</title>
...
<main class="form-signin">
  <form>
    ...
    <h1 class="h3 mb-3 fw-normal"> <font face="Comic Sans MS,arial,verdana" class="text-success">Por favor, Ingrese su Correo</font></h1>
    ...
    <button class="w-100 btn btn-lg btn-success" type="button" id="send_email">Send Email</button>
    <div class="form-floating mt-2">
      <a href="login.php" class="text-success">¿Ya cuentas con una cuenta? Inicia sesión Aquí</a>
    </div>
